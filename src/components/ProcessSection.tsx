        ...
        <div className="space-y-16 lg:space-y-24">
          {steps.map((step, index) => (
            ...
            >
              ...
              >
                <div className={`aspect-[4/3] rounded-2xl overflow-hidden shadow-elevated ${step.objectFit === "contain" ? "bg-[#f0f4f8]" : ""}`}>
                  <img
                    src={step.image}
                    alt={step.title}
                    className={`w-full h-full transition-transform duration-700 hover:scale-105 ${
                      step.objectFit === "contain" ? "object-contain" : "object-cover"
                    }`}
                  />
                </div>
              </div>
